...
const About = () => {
  return (
    <div className='flex justify-center items-center min-h-screen bg-[#191423] py-20 px-5'>
      <div className='max-w-[1145px] mx-auto overflow-auto'>
      <div className='flex items-center w-full gap-16 flex-wrap justify-center max-lg:gap-12 max-md:gap-8'>
            ...
            {TABLE_PRACTICE_LIST.map((obj, i) => (   
              <div key={i}>
                ...
                <div className={`px-[15.78px] min-h-[53.61px] flex justify-center items-center min-w-[94px] max-w-[94px] rounded-b-md ${i === 3 ? "bg-[#56E3CB]":"bg-white"}`}>
                    <p className='text-[6px]'>{obj.lineSix}</p>
                  </div>
                </div>
              </div>           
            )            
